...
1. In a file 1-redis_op.js, copy the code you previously wrote (0-redis_client.js).
...
2. In a file 2-redis_op_async.js, let’s copy the code from the previous exercise (1-redis_op.js)

Using promisify, modify the function displaySchoolValue to use ES6 async / await

Same result as 1-redis_op.js

3. In a file named 4-redis_advanced_op.js, let’s use the client to store a hash value
...
8. In a file named 7-job_processor.js:
...
9. In a file named 8-job.js, create a function named createPushNotificationsJobs:
...
10. Now that you created a job creator, let’s add tests:
